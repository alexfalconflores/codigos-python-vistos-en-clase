...
final_grade = float(input("Ingresa la nota final: "))

# TODO 2: solicita la asistencia y conviértela a float.
attendance = float(input("Ingresa la asistencia (en porcentaje): "))

# TODO 3: solicita el código de modalidad.
modality_code = input("Ingresa el código de modalidad (P/V/H): ")
...
# pero la asistencia es menor que 70.
    ...
    result = "Aprobado por nota, desaprobado por asistencia"
